...
const getApiBaseUrl = () => {
  ...
  // Production configuration for Formonex domain
  if (window.location.hostname === 'ems.formonex.in') {
    // Use same domain for API to avoid mixed content (requires backend proxy setup)
    return 'https://ems.formonex.in/api';
  }
