  ...
  const fetchUserDashboardData = async () => {
    try {
      const [attendanceRes, leavesRes, worksheetsRes] = await Promise.all([
        api.get('/attendance/my-attendance').catch(() => ({ data: { data: {} } })),
        api.get('/leaves/my-leaves').catch(() => ({ data: { data: [] } })),
        api.get('/worksheets/my-worksheets').catch(() => ({ data: { data: [] } }))
      ]);
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {dashboardData.attendance.attendanceRate || '0'}%
                </p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {dashboardData.leaves.length || 0} days
                </p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {dashboardData.worksheets.length || 0}
                </p>
              </div>
