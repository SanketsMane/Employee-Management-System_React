      ...
      <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center space-x-3">
                ...
                />
                <div className="h-10 w-10 bg-gradient-to-br from-blue-600 to-purple-600 dark:from-blue-500 to-purple-500 rounded-lg flex items-center justify-center" style={{display: 'none'}}>
        ...
        <section className="py-16 bg-gray-50 dark:bg-gray-800/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {stats.map((stat, index) => (
                ...
                >
                  ...
                  >
                    ...
                    {/* Hover effect */}
                    <motion.div 
                      className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-purple-500/5 rounded-lg -z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                      initial={false}
                    />
                  </motion.div>
                </motion.div>
            ...
            {/* Remove Company Logos Carousel from here */}
          </div>
        </section>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-300">formonexsolutions@gmail.com</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-4">
                      <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900 rounded-lg flex items-center justify-center">
